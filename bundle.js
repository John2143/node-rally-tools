...
class lib {
  ...
  static async makeAPIRequest({
    ...
    if (fullPath) path_full = fullPath; //Keys are defined in environment variables
...
async function $prefix(propArray) {
