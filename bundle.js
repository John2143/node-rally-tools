...
var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _dec31, _dec32, _dec33, _dec34, _dec35, _dec36, _dec37, _dec38, _dec39, _dec40, _dec41, _dec42, _dec43, _dec44, _dec45, _dec46, _dec47, _dec48, _dec49, _dec50, _dec51, _dec52, _dec53, _dec54, _dec55, _dec56, _dec57, _dec58, _dec59, _dec60, _dec61, _dec62, _dec63, _obj;
...
let cli = (_dec = helpText(`Display the help menu`), _dec2 = usage(`rally help [subhelp]`), _dec3 = param("subhelp", "The name of the command to see help for"), _dec4 = helpText("Rally tools jupyter interface. Requires jupyter to be installed."), _dec5 = usage("rally jupyter build [in] [out]"), _dec6 = param("in/out", "input and output file for jupyter. By default main.ipyrb and main.py"), _dec7 = helpText("Prepare an environment to hold specific branches"), _dec8 = usage("rally help stage"), _dec9 = helpText(`Preset related actions`), _dec10 = usage(`rally preset [action] --env <enviornment> --file [file1] --file [file2] ...`), _dec11 = param("action", "The action to perform. Can be upload, diff, list, deleteRemote"), _dec12 = arg("-e", "--env", "The enviornment you wish to perform the action on"), _dec13 = arg("-f", "--file", "A file to act on"), _dec14 = arg("~", "--command", "If the action is diff, this is the command to run instead of diff"), _dec15 = helpText(`Rule related actions`), _dec16 = usage(`rally rule [action] --env [enviornment]`), _dec17 = param("action", "The action to perform. Only list is supported right now"), _dec18 = arg("-e", "--env", "The enviornment you wish to perform the action on"), _dec19 = helpText(`supply chain related actions`), _dec20 = usage(`rally supply [action] [identifier] --env [enviornment] [post actions]`), _dec21 = param("action", "The action to perform. Can be calc or make."), _dec22 = param("identifier", "If the action is calc, then this identifier should be the first rule in the chain. If this is make, then supply '-' to read from stdin"), _dec23 = param("post actions", "The action to perform on the created supply chain. See commands below"), _dec24 = arg("-e", "--env", "(calc only) environment to do the calculation on"), _dec25 = arg("~", "--diff", "(post action) Use as `--diff [env]`. List all files with differences on the given env."), _dec26 = arg("~", "--to", "(post action) Use as `--to [env]`. Upload all objects."), _dec27 = arg("~", "--delete", "(post action) Use as `--delete [env]`. The reverse of uploading. Only presets are supported right now."), _dec28 = helpText(`tags stuff`), _dec29 = usage(`rally tags [action]`), _dec30 = param("action", "The action to perform. Can be list, create, or curate."), _dec31 = arg("-e", "--env", "The enviornment you wish to perform the action on"), _dec32 = helpText(`print out some trace info`), _dec33 = usage(`rally trace -e [env] [jobid]`), _dec34 = param("jobid", "a job id like b86d7d90-f0a5-4622-8754-486ca8e9ecbd"), _dec35 = arg("-e", "--env", "The enviornment you wish to perform the action on"), _dec36 = helpText(`List all available providers, or find one by name/id`), _dec37 = usage(`rally providers [identifier] --env [env] --raw`), _dec38 = param("identifier", "Either the name or id of the provider"), _dec39 = arg("-e", "--env", "The enviornment you wish to perform the action on"), _dec40 = arg("~", "--raw", "Raw output of command. If [identifier] is given, then print editorConfig too"), _dec41 = helpText(`Change config for rally tools`), _dec42 = usage("rally config [key] --set [value] --raw"), _dec43 = param("key", chalk`Key you want to edit. For example, {green chalk} or {green api.DEV}`), _dec44 = arg("~", "--set", "If this value is given, no interactive prompt will launch and the config option will change."), _dec45 = arg("~", "--raw", "Raw output of json config"), _dec46 = helpText(`create/modify asset or files inside asset`), _dec47 = usage("rally asset [action] [action...]"), _dec48 = param("action", chalk`Actions are create, delete, launch, addfile, metadata, show, patchMetadata, and launchEvalute, deleteFile, downloadFile, grep, analyze. You can supply multiple actions to chain them.`), _dec49 = arg(`-i`, `--id`, chalk`MOVIE_ID of asset to select`), _dec50 = arg(`-n`, `--name`, chalk`MOVIE_NAME of asset. with {white create}, '{white #}' will be replaced with a uuid. Default is '{white TEST_#}'`), _dec51 = arg(`~`, `--anon`, chalk`Supply this if no asset is needed (used to lauch anonymous workflows)`), _dec52 = arg(`-j`, `--job-name`, chalk`Job name to start (used with launch and launchEvalute)`), _dec53 = arg(`~`, `--init-data`, chalk`Init data to use when launching job. can be string, or {white @path/to/file} for a file`), _dec54 = arg(`~`, `--file-label`, chalk`File label (used with addfile)`), _dec55 = arg(`~`, `--file-uri`, chalk`File s3 uri. Can use multiple uri's for the same label (used with addfile)`), _dec56 = arg(`~`, `--metadata`, chalk`Metadata to use with patchMetadata. Can be string, or {white @path/to/file} for a file. Data must contain a top level key Metadata, or Workflow. Metadata will be pached into METADATA. Workflow will be patched into WORKFLOW_METADATA(not currently available)`), _dec57 = arg(`~`, `--priority`, chalk`set the priority of all launched jobs`), _dec58 = arg(`~`, `--new-name`, chalk`set the new name`), _dec59 = arg(`~`, `--target-env`, chalk`migrate to the env (when using migrate)`), _dec60 = arg(`~`, `--to-folder`, chalk`Folder to download to when using downloadFile. If no folder is given, writes to stdout.`), _dec61 = arg(`~`, `--artifact`, chalk`This is the artifact to grep on. Defaults to trace. Values are "trace", "preset", "result", "error", "output"`), _dec62 = arg(`~`, `--on`, chalk`alias for artifact`), _dec63 = arg(`~`, `--name-only`, chalk`Only show preset name and number of matches when greping`), (_obj = {
  async help(args) {
    let arg = args._.shift();
