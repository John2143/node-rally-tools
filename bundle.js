...
var _class;
let Provider = (_class = class Provider {
...
}, (_applyDecoratedDescriptor(_class, "getProviders", [cached], Object.getOwnPropertyDescriptor(_class, "getProviders"), _class)), _class);
...
var _class$2;
let Notification = (_class$2 = class Notification {
  constructor(data, env) {
    this.data = data;
    this.meta = {};
    this.remote = env;
  ...
  static async getNotifications(env) {
...
}, (_applyDecoratedDescriptor(_class$2, "getNotifications", [cached], Object.getOwnPropertyDescriptor(_class$2, "getNotifications"), _class$2)), _class$2);
...
let Rule = (_class$3 = class Rule extends RallyBase {
  ...
  static async getRules(env) {
    ...
    return new Collection(rules.map(data => new Rule({
      data,
      remote: env
    })));
  }

}, (_applyDecoratedDescriptor(_class$3, "getRules", [cached], Object.getOwnPropertyDescriptor(_class$3, "getRules"), _class$3)), _class$3);
...
let presetsub = {
  ...
  async $create(args) {
    ...
    if (args.provider) {
      ...
      provider = await selectProvider((await Provider.getProviders(this.env)));
